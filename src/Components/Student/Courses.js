    ...
    try {
      ...
      const response = await fetch('https://hydersoft.com/api/payments/create-checkout-session', {
        ...
        body: JSON.stringify({
          course_id: course.course_id,
          student_id: studentId,
          user_id: studentId, // Send both to handle validation inconsistencies
        }),
      });
      ...
      if (error.name === 'SyntaxError' && error.message.includes('Unexpected token')) {
        alert('Server error: The payment service is currently unavailable. Please try again later.');
